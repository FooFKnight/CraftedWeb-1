<?php
    ...
    /* General settings      
      /************************ */
    $useDebug = true; //If you are having problems with your website, set this to "true", if not, set to "false". 
    ...
    $website_domain = '12'; //Provide the domain name AND PATH to your website.
